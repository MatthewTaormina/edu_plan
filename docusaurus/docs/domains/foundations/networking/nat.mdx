...
<svg viewBox="0 0 680 200" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="SNAT step-by-step diagram" style={{width:'100%',display:'block',margin:'1.5rem auto'}}>
  <defs>
  ...
  <text x="78" y="48" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Laptop sends request</text>
  ...
  <text x="270" y="42" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">→ 203.0.113.5:40001</text>
  <text x="270" y="54" textAnchor="middle" fontFamily="sans-serif" fontSize="9" fill="var(--ifm-color-emphasis-700)">Router rewrites + logs</text>
  ...
  <text x="462" y="48" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Google sees this IP</text>
  ...
  <text x="364" y="142" textAnchor="middle" fontFamily="sans-serif" fontSize="9" fill="var(--ifm-color-emphasis-800)">Router translates back using its mapping table</text>
  <line x1="192" y1="130" x2="152" y2="130" stroke="#10b981" strokeWidth="1.5" markerEnd="url(#nat-arrow-green)"/>

  {/* Laptop label on return */}
  <text x="78" y="130" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Laptop receives reply</text>
