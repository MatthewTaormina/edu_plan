...
<svg viewBox="0 0 640 230" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="L4 vs L7 load balancer comparison" style={{maxWidth:'640px',width:'100%',display:'block',margin:'1.5rem auto'}}>
  {/* L4 column */}
