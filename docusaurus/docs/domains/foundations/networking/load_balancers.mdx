...
<svg viewBox="0 0 640 230" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="L4 vs L7 load balancer comparison" style={{width:'100%',display:'block',margin:'1.5rem auto'}}>
  ...
  <text x="24" y="156" fontFamily="sans-serif" fontSize="12" fill="var(--ifm-color-emphasis-700)">❌ Cannot inspect URLs or headers</text>
  <text x="24" y="178" fontFamily="sans-serif" fontSize="12" fill="var(--ifm-color-emphasis-700)">❌ No content-based routing</text>
  ...
  <text x="352" y="178" fontFamily="sans-serif" fontSize="12" fill="var(--ifm-color-emphasis-700)">❌ HTTP only · slightly more overhead</text>
