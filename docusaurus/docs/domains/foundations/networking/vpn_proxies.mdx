...
<svg viewBox="0 0 640 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Forward proxy vs reverse proxy diagram" style={{width:'100%',display:'block',margin:'1.5rem auto'}}>
  ...
  <text x="160" y="100" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Client-side — hides your identity</text>
  <text x="160" y="114" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Server sees proxy IP, not yours</text>
  ...
  <text x="480" y="100" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Server-side — hides backend topology</text>
  <text x="480" y="114" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Client sees one IP — proxy handles routing</text>
