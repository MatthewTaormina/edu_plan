...
<svg viewBox="0 0 640 220" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Forward proxy vs reverse proxy diagram" style={{maxWidth:'640px',width:'100%',display:'block',margin:'1.5rem auto'}}>
  <defs>
