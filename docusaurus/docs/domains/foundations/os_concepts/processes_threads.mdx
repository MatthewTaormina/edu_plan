...
<svg viewBox="0 0 640 230" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Process and thread anatomy diagram" style={{width:'100%',display:'block',margin:'1.5rem auto'}}>
  <defs>
  ...
  <text x="300" y="169" textAnchor="middle" fontFamily="monospace" fontSize="10" fill="var(--ifm-color-emphasis-800)">All threads read and write here — race conditions happen here</text>
  ...
  <text x="300" y="212" textAnchor="middle" fontFamily="monospace" fontSize="10" fill="var(--ifm-color-emphasis-800)">fd:3 (socket) · fd:4 (log file) — shared across all threads</text>
</svg>
