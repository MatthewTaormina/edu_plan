...
<svg viewBox="0 0 760 460" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Virtual address space layout diagram" style={{width:'100%',display:'block',margin:'1.5rem auto'}}>
  ...
  {/* HIGH address label */}
  <text x="4" y="42" fontFamily="monospace" fontSize="13" fill="var(--ifm-color-emphasis-700)">0xFFFF…</text>
  <text x="4" y="58" fontFamily="monospace" fontSize="11" fill="var(--ifm-color-emphasis-600)">(top)</text>

  {/* LOW address label */}
  <text x="4" y="414" fontFamily="monospace" fontSize="13" fill="var(--ifm-color-emphasis-700)">0x0000</text>
  <text x="4" y="430" fontFamily="monospace" fontSize="11" fill="var(--ifm-color-emphasis-600)">(bottom)</text>
  ...
  <text x="450" y="58" textAnchor="middle" fontFamily="sans-serif" fontSize="13" fill="var(--ifm-color-emphasis-800)">OS code and data — user programs cannot access directly</text>
  ...
  <text x="450" y="128" textAnchor="middle" fontFamily="sans-serif" fontSize="13" fill="var(--ifm-color-emphasis-800)">grows downward ↓  ·  local variables, function call frames, return addresses</text>
  ...
  <text x="450" y="192" textAnchor="middle" fontFamily="sans-serif" fontSize="15" fontWeight="600" fill="var(--ifm-color-emphasis-600)">— unmapped gap —</text>
  <text x="450" y="214" textAnchor="middle" fontFamily="sans-serif" fontSize="13" fill="var(--ifm-color-emphasis-600)">touch this → Segmentation Fault (Linux) / Access Violation (Windows)</text>
  ...
  <text x="450" y="292" textAnchor="middle" fontFamily="sans-serif" fontSize="13" fill="var(--ifm-color-emphasis-800)">grows upward ↑  ·  malloc() / new allocations · managed by allocator</text>
  ...
  <text x="450" y="367" textAnchor="middle" fontFamily="sans-serif" fontSize="13" fill="var(--ifm-color-emphasis-800)">global variables (Data = initialised, BSS = zero-initialised)</text>
  ...
  <text x="450" y="429" textAnchor="middle" fontFamily="sans-serif" fontSize="13" fill="var(--ifm-color-emphasis-800)">compiled machine instructions · read-only · shared between forked processes</text>

  {/* ── NULL note ── */}
  <text x="450" y="452" textAnchor="middle" fontFamily="monospace" fontSize="12" fill="var(--ifm-color-emphasis-600)">0x0 = NULL — null pointer dereferences crash here</text>
</svg>
