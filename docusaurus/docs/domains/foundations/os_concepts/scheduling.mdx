...
<svg viewBox="0 0 620 120" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Linux nice vs Windows priority comparison" style={{width:'100%',display:'block',margin:'1.5rem auto'}}>
  {/* Linux scale */}
  ...
  <text x="145" y="68" textAnchor="middle" fontFamily="monospace" fontSize="10" fill="var(--ifm-color-emphasis-800)">0 (default)</text>
  ...
  <text x="160" y="100" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Negative values require root</text>
  ...
  <text x="460" y="100" textAnchor="middle" fontFamily="sans-serif" fontSize="10" fill="var(--ifm-color-emphasis-800)">Realtime can starve system processes</text>
</svg>
