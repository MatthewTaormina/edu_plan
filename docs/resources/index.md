...
> When in doubt, come here first. These are the sources every unit links back to.
...
|----------|------|--------|
| [PostgreSQL Docs](https://www.postgresql.org/docs/) | **Official** | The most important SQL reference |
| [MySQL Docs](https://dev.mysql.com/doc/) | **Official** | MySQL / MariaDB |
| [SQLite Docs](https://www.sqlite.org/docs.html) | **Official** | Lightweight embedded database |
| [MongoDB Manual](https://www.mongodb.com/docs/manual/) | **Official** | NoSQL document database |
| [Redis Documentation](https://redis.io/documentation) | **Official** | In-memory key-value store |
| [SQL Tutorial — Mode](https://mode.com/sql-tutorial/) | Trusted | Practical SQL for data analysis |
...
| Resource | Type | Notes |
|----------|------|-------|
| [PyTorch Docs](https://pytorch.org/docs/stable/index.html) | **Official** | The primary ML framework |
| [Hugging Face Docs](https://huggingface.co/docs) | **Official (HF)** | Models, Transformers, Datasets |
| [OpenAI API Reference](https://platform.openai.com/docs/api-reference) | **Official** | GPT-4, Embeddings, Whisper APIs |
| [fast.ai Course (FREE)](https://course.fast.ai/) | Trusted | Best practical deep learning intro |
...
| Resource | Type | Notes |
|----------|------|-------|
| [OWASP Top 10](https://owasp.org/www-project-top-ten/) | **Official (OWASP)** | The 10 most critical web security risks |
| [OWASP Cheat Sheet Series](https://cheatsheetseries.owasp.org/) | **Official (OWASP)** | Practical security guidance per topic |
| [CVE Database (NVD)](https://nvd.nist.gov/) | **Official (NIST)** | All publicly known vulnerabilities |
| [CWE List](https://cwe.mitre.org/) | **Official (MITRE)** | Common Weakness Enumeration |
| [Have I Been Pwned](https://haveibeenpwned.com/) | Trusted | Check if credentials have been breached |

---

## 📐 Standards Bodies

| Body | Site | Key Standards |
|------|------|--------------|
| IETF | [ietf.org](https://www.ietf.org/) | Internet protocols — all RFCs |
| RFC Editor | [rfc-editor.org](https://www.rfc-editor.org/) | Read any RFC directly |
| W3C | [w3.org](https://www.w3.org/) | HTML, CSS, SVG, WebAssembly |
| ECMA | [ecma-international.org](https://www.ecma-international.org/) | JavaScript (ECMAScript) |
| IEEE | [ieee.org](https://www.ieee.org/) | Wi-Fi, Ethernet standards |
| ISO | [iso.org](https://www.iso.org/) | Dates (8601), security (27001) |
| NIST | [nist.gov](https://www.nist.gov/) | Security frameworks, cryptography |
| OpenAPI | [spec.openapis.org](https://spec.openapis.org/) | REST API description standard |
...
|----------|-------|---------|
| [CS50 (Harvard)](https://cs50.harvard.edu/) | ✅ Free | CS fundamentals, Python, Web, Cybersecurity |
| [The Odin Project](https://www.theodinproject.com/) | ✅ Free | Web dev (HTML, JS, Ruby, Node) - project-based |
| [fast.ai](https://www.fast.ai/) | ✅ Free | Practical deep learning, top-down approach |
| [Exercism](https://exercism.org/) | ✅ Free | Language tracks with mentoring (50+ languages) |
| [LeetCode](https://leetcode.com/) | Freemium | Algorithms, data structures, interview prep |
| [Advent of Code](https://adventofcode.com/) | ✅ Free | Annual programming puzzles, any language |
| [Regex Crossword](https://regexcrossword.com/) | ✅ Free | Regex practice through puzzles |
| [SQLZoo](https://sqlzoo.net/) | ✅ Free | Interactive SQL practice |
| [OverTheWire](https://overthewire.org/wargames/) | ✅ Free | Security/CTF challenges starting from scratch |
| [Udemy](https://www.udemy.com/) | Paid (sales) | Broad coverage — wait for $10-15 sales |
| [Coursera](https://www.coursera.org/) | Audit free | University courses with certificates |
| [MIT OpenCourseWare](https://ocw.mit.edu/) | ✅ Free | Actual MIT course materials, rigorous |

---

## 🛠️ Developer Tools & References

| Tool | Site | Notes |
|------|------|-------|
| Regex testing | [regex101.com](https://regex101.com/) | Live tester, explanation, multiple flavors |
| JSON formatter | [jsonlint.com](https://jsonlint.com/) | Validate and format JSON |
| Color palette | [coolors.co](https://coolors.co/) | Generate harmonious color schemes |
| HTTP status codes | [httpstatuses.com](https://httpstatuses.com/) | Short reference for all status codes |
| SSL checker | [ssllabs.com/ssltest/](https://www.ssllabs.com/ssltest/) | Test TLS configuration of any domain |
| Subnet calculator | [subnet-calculator.com](https://www.subnet-calculator.com/) | CIDR and subnet math |
| DNS propagation | [dnschecker.org](https://dnschecker.org/) | Check DNS from global resolvers |
| Cron expression | [crontab.guru](https://crontab.guru/) | Build and explain cron schedules |
| Git ignore templates | [gitignore.io](https://www.toptal.com/developers/gitignore) | Generate .gitignore for any stack |
| Algorithm visualizer | [visualgo.net](https://visualgo.net/) | Animate data structures and algorithms |
| API testing | [hoppscotch.io](https://hoppscotch.io/) | Open-source Postman alternative |
| YAML validator | [yamllint.com](https://www.yamllint.com/) | Validate YAML files |
| Base64 / encoding | [base64decode.org](https://www.base64decode.org/) | Encode/decode common formats |
| Diff checker | [diffchecker.com](https://www.diffchecker.com/) | Compare two blocks of text |
