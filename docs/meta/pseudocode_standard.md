...
1. **Readable aloud** — any programmer should be able to read it out loud and understand it
2. **Unambiguous** — no two readers should interpret a line differently
3. **Whiteboard-friendly** — it's what you'd write if explaining on a whiteboard
...
// With types — preferred for teaching
...
Use `←` for assignment to distinguish from equality comparison `==`.  
...
## Full Example — Linked List Insert
...
| Situation | Use |
|-----------|-----|
| Explaining a concept or algorithm | ✅ Pseudocode first |
| Showing language-specific syntax | ✅ Tabbed real code |
| Assignments / exercises | ✅ Tabbed real code (show in 2–3 languages) |
| Language-specific behavior (ownership, GIL, etc.) | ✅ That language only, labeled |
...
**Language tab order convention:** `Pseudocode → Python → TypeScript → Rust → C/C++ → Java/Kotlin → C#`  
